...
- Regra implementada: se existir solicitacao ativa para o mesmo `poste_id`, a API nao deve criar nova solicitacao para `localizacao_tipo = poste_mapa` e deve retornar `409 Conflict`.
