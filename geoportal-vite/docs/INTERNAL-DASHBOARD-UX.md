...
- Validar em piloto controlado o relatorio administrativo sanitizado v1, incluindo recorte geral sem datas, filtros opcionais, CSV compativel com Excel, resumo JSON e ausencia de dados pessoais livres na exportacao.
