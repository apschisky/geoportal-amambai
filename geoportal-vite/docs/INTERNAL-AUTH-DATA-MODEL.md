...
O serviço interno de hash/verificação de senha com Argon2id já foi implementado e validado, mas não há login funcional, endpoint interno exposto, usuário real, sessão ou token.
