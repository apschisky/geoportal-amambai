...
12. → Implementar atraso progressivo e bloqueio temporário persistente integrados.
13. → Criar feature flag para ativar rotas internas controladas.
14. → Criar testes automatizados de acesso negado/autorizado com rota controlada, dependency ou middleware.
15. → Criar endpoint de login em homologação com auditoria/rate limit integrados.
16. → Criar endpoints internos mínimos, todos protegidos.
17. → Criar tela interna mínima.
18. → Fazer revisão de segurança antes de uso por equipe real.
