...
Sequencia segura recomendada a partir daqui: validar `GET /api/internal/admin/users` em homologacao; depois planejar endpoints administrativos mutaveis gradualmente com permissoes especificas, testes e auditoria; depois criar o primeiro endpoint interno de negocio do modulo Iluminacao; tela interna continua etapa posterior. Producao permanece sem alteracao nesta etapa.
