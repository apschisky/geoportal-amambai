...
Sequencia segura recomendada a partir daqui: validar a listagem de perfis em homologacao; planejar bloqueio/desbloqueio de usuario; planejar reset de senha via endpoint; depois criar o primeiro endpoint interno de negocio do modulo Iluminacao; tela interna continua etapa posterior. Producao permanece sem alteracao nesta etapa.
