...
A shell continua sem alteracao de prioridade, dashboard real, mapa operacional, anexos, logout ou rota Google Maps. Reabertura ou correcao administrativa de status terminal ficam fora desta fase. A proxima subfase recomendada e inventariar o contrato de prioridade antes de qualquer implementacao de alteracao de prioridade.
