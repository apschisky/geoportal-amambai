...
7. Fase 7: implementar correcao administrativa de status em subfases, somente apos revisao humana do contrato: confirmar schema/historico, implementar backend local com testes, aplicar migration apenas se valores de auditoria faltarem, validar GRANT minimo em homologacao, validar com chamado teste/controlado, entao expor acao administrativa no frontend. Manutencao continua sem essa permissao.
