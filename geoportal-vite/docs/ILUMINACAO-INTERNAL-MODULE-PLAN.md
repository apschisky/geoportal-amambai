...
A shell continua sem alteracao de status, dashboard real, mapa operacional, anexos, logout ou rota Google Maps. A proxima subfase recomendada e inventariar o contrato da alteracao normal de status antes de qualquer implementacao de `PATCH`.
