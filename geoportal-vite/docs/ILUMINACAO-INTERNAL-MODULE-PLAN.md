...
5. Fase 5: endpoints internos protegidos para historico, observacoes e status. Leitura de historico, leitura de observacoes internas e criacao de observacao interna ja foram validadas em homologacao; alteracao de status foi implementada no backend conforme contrato de transicoes, `finalizado_em`, observacao obrigatoria e auditoria, com validacao operacional ainda posterior.
