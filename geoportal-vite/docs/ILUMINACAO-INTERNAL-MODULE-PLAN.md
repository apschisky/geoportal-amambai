...
5. Fase 5: endpoints internos protegidos para historico, observacoes e status. Leitura de historico, leitura de observacoes internas e criacao de observacao interna ja foram validadas em homologacao; status segue etapa posterior conforme contrato planejado de transicoes, `finalizado_em`, observacao obrigatoria e auditoria.
