...
O serviço interno de hash/verificação de senha usando Argon2id foi implementado e validado localmente e no servidor. Ainda não há login funcional, endpoint interno de autenticação ou middleware de autorização exposto.
